...
static UIColor* Black_;
static UIColor* White_;
static UIColor* Gray_;
static UIColor* Purple_;
static UIColor* Purplish_;
...
- (void) drawNormalContentRect:(CGRect)rect
{
    ...
    if (highlighted && kCFCoreFoundationVersionNumber < 800) {
		UISetColor(White_.CGColor);
	}
	
    if (!highlighted) {
		UISetColor(commercial_ ? Purple_.CGColor : Black_.CGColor);
	}
    ...
    if (!highlighted) {
		UISetColor(commercial_ ? Purplish_.CGColor : Gray_.CGColor);
	}
...
__attribute__((constructor)) static void initialize_CellDia()
{
	...
	FontSource_ = [[UIFont systemFontOfSize:10] copy];
	FontDescription_ = [[UIFont systemFontOfSize:11] copy];
	FontName_ = [[UIFont boldSystemFontOfSize:12] copy];
	
	Black_ = [[UIColor colorWithRed:0.00 green:0.00 blue:0.00 alpha:1.0] copy];
	White_ = [[UIColor colorWithRed:1.00 green:1.00 blue:1.00 alpha:1.0] copy];
	Gray_ = [[UIColor colorWithRed:0.40 green:0.40 blue:0.40 alpha:1.0] copy];
	Purple_ = [[UIColor colorWithRed:0.0 green:0.0 blue:0.7 alpha:1.0] copy];
	Purplish_ = [[UIColor colorWithRed:0.4 green:0.4 blue:0.8 alpha:1.0] copy];
	
	kNew = [[[NSBundle mainBundle] localizedStringForKey:@"NEW" value:@"New" table:nil] copy];
	kUpdate = [[[NSBundle mainBundle] localizedStringForKey:@"UPGRADE" value:@"Upgrade" table:nil] copy];
	kInstall = [[[NSBundle mainBundle] localizedStringForKey:@"INSTALL" value:@"Install" table:nil] copy];
	kRemove = [[[NSBundle mainBundle] localizedStringForKey:@"REMOVE" value:@"Remove" table:nil] copy];
	kNewAt = [[[[NSBundle mainBundle] localizedStringForKey:@"NEW_AT" value:nil table:nil]?:@"" stringByReplacingOccurrencesOfString:@"%@" withString:@""] copy];
